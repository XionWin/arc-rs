...
impl GetPName {   
    ...
    pub const SampleAlphaToCoverage: GetPName = GetPName::SampleAlphaToMaskSgis;
    pub const SampleCoverage: GetPName = GetPName::SampleMaskSgis;
    pub const SampleBuffersSgis: GetPName = GetPName::SampleBuffers;
    pub const SamplesSgis: GetPName = GetPName::Samples;
    pub const SampleCoverageValue: GetPName = GetPName::SampleMaskValueSgis;
    pub const SampleCoverageInvert: GetPName = GetPName::SampleMaskInvertSgis;
